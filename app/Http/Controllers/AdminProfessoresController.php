<?php namespace App\Http\Controllers;
	...
	class AdminProfessoresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Disciplinas","name"=>"disciplina"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nome','name'=>'nome','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Complemento','name'=>'complemento','type'=>'text','validation'=>'min:1|max:50','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'CEP','name'=>'cep','type'=>'text','validation'=>'required|min:1|max:9','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'RG','name'=>'rg','type'=>'text','validation'=>'required|min:1|max:13','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'CPF','name'=>'cpf','type'=>'text','validation'=>'required|min:1|max:14','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Telefone de Contato','name'=>'telefoneContato','type'=>'text','validation'=>'required|min:1|max:15','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Disciplina','name'=>'disciplina','type'=>'textarea','validation'=>'required|string|min:1|max:200','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Disciplina","name"=>"disciplina","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
